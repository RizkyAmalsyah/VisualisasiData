      ...
      <div class="dropdown-menu dropdown-menu-end mt-10-f me--10-f">
        ...
        <ul class="list-group">
          <li class="list-group-item">
            <div class="avatar online"><img src="/img/img10.jpg" alt=""></div>
          ...
          <li class="list-group-item">
            <div class="avatar online"><img src="/img/img11.jpg" alt=""></div>
            <div class="list-group-body">
          ...
          <li class="list-group-item">
            <div class="avatar online"><img src="/img/img14.jpg" alt=""></div>
            <div class="list-group-body">
          ...
          <li class="list-group-item">
            <div class="avatar online"><img src="/img/img15.jpg" alt=""></div>
            <div class="list-group-body">
